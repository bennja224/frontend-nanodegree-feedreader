...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         * empty. Experimented with this before getting started on
         * the rest of this project. What happens when you change
         * allFeeds in app.js to be an empty array and refresh the
         * page? (errors on the page and then once added back no errors)
         */
         ...
         */
		 it('ensures allFeeds has a name defined and is not empty', function() {
			allFeeds.forEach(function(feed) {
	...
	describe('New Feed Selection', function() {
         ...
         */
		 ...
		 it('new feeds load on click', function() {
			 newUrl = $('.feed').html();
			 expect($('.feed')).not.toEqual(newUrl);
		 });
	});
});
